      ...
      <div className="surface-glow mx-auto max-w-6xl rounded-3xl border border-zinc-700/80 bg-zinc-950 p-6 text-zinc-100 sm:p-8 lg:p-10">
        ...
        <ul className="mt-8 grid list-none grid-cols-1 gap-4 sm:grid-cols-2">
          {problems.map((item) => {
            ...
            return (
              <li key={item.text}>
                <div className="interactive-card group relative overflow-hidden rounded-2xl border border-zinc-800 bg-gradient-to-br from-zinc-900/90 to-zinc-950/90 p-6">
                  <div
