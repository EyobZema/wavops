...
export default function ProblemSection() {
  return (
    <section id="problem" className="animate-fade-up px-6 py-16 lg:px-10 lg:py-20">
      <div className="mx-auto max-w-6xl rounded-3xl border border-zinc-700/80 bg-zinc-950 p-8 text-zinc-100 shadow-[0_20px_50px_rgba(0,0,0,0.45)] lg:p-10">
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2">
          {problems.map((item) => (
            <div
              key={item}
              className="interactive-card rounded-2xl border border-zinc-800 bg-zinc-900/70 p-5 text-zinc-200"
            >
              {item}
            </div>
          ))}
