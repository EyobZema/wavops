...
export default function HeroSection() {
  return (
    <section
      id="top"
      className="animate-fade-up px-4 pb-12 pt-12 sm:px-6 lg:px-10 lg:pb-20 lg:pt-24"
    >
      <div className="mx-auto max-w-6xl">
        ...
        <h1 className="section-title max-w-5xl text-3xl font-semibold tracking-tight text-foreground sm:text-4xl md:text-6xl lg:text-7xl">
        ...
        <div className="mt-6 flex flex-col gap-3 sm:mt-8 sm:flex-row sm:items-center sm:gap-4">
          <a
            ...
            className="rounded-full bg-zinc-100 px-6 py-2.5 text-center text-sm font-semibold text-zinc-950 transition hover:-translate-y-0.5 hover:bg-white hover:shadow-[0_10px_30px_rgba(255,255,255,0.12)] sm:px-7 sm:py-3"
          >
            Get Free Dataset Audit
          </a>
          <a
            href="/how-wavops-works"
            className="rounded-full border border-zinc-700 bg-zinc-900/80 px-6 py-2.5 text-center text-sm font-medium text-zinc-200 transition hover:-translate-y-0.5 hover:border-zinc-500 hover:bg-zinc-800/80 sm:px-7 sm:py-3"
          >
            See How It Works
          </a>
        </div>
