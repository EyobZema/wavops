export default function CtaSection() {
  return (
    <section id="cta" className="animate-fade-up px-6 py-20 lg:px-10 lg:py-24">
      <div className="surface-glow mx-auto max-w-6xl rounded-3xl border border-zinc-700/80 bg-zinc-950 px-8 py-12 text-center text-zinc-100 backdrop-blur-sm lg:px-12">
